...
public class LRNoHandExperimentController : MonoBehaviour
{
    public Transform rightHandController;
    public MovementLogger dataLogger;
    public TargetController targetController;
    public LRNoHandPenaltyController PenaltyController;
    ...
    IEnumerator RunTrials()
    {
        ...
        while (true)
        {
            LRNoHandTrialCondition condition = LRNoHandTrialManager.Instance.GetNextTrial();
            if (condition == null)
            {
            ...
            trialCount++;
            Debug.Log($"Starting Trial {trialCount}/{LRNoHandTrialManager.Instance.TotalTrialCount}");
            ...
            if (earlyExit && outcome == "Too Early")
            {
                ...
                LRNoHandTrialManager.Instance.ReinsertTrial(condition);
