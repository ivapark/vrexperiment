...
public class FBNoHandPenaltyController : MonoBehaviour
{
    ...
    /// <summary>
    /// Applies a front/back penalty zone based on penaltyIndex.
    /// If penaltyIndex == 0, no penalty is applied.
    /// Mapping: 1 = front (+Z), 2 = back (-Z)
    /// </summary>
    public void ApplyPenalty(GameObject target, int penaltyIndex)
    {
        ...
        // Directions: 1=front, 2=back
        Vector3 dir = penaltyIndex switch
        {
            1 => Vector3.forward,
            2 => Vector3.back,
            _ => Vector3.forward // fallback
        };
