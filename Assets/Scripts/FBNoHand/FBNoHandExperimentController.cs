...
public class FBNoHandExperimentController : MonoBehaviour
{
    public Transform rightHandController;
    public MovementLogger dataLogger;
    public TargetController targetController;
    public FBNoHandPenaltyController PenaltyController;
    ...
    IEnumerator RunTrials()
    {
        ...
        while (true)
        {
            FBNoHandTrialCondition condition = FBNoHandTrialManager.Instance.GetNextTrial();
            if (condition == null)
            {
            ...
            trialCount++;
            Debug.Log($"Starting Trial {trialCount}/{FBNoHandTrialManager.Instance.TotalTrialCount}");
            ...
            if (earlyExit && outcome == "Too Early")
            {
                ...
                FBNoHandTrialManager.Instance.ReinsertTrial(condition);
    ...
    private void ShowEndpointMarker(Vector3 position)
    {
        ...
        {
            Debug.LogWarning("[FBExperimentController] No endpointMarkerPrefab assigned.");
            return;
        }
